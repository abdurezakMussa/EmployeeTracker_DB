...
function addEmployee(){
    ...
    promisemysql.createConnection(connectionProperties
        ...
        // Its method that add option for no manager
        managerArr.unshift('--');
        ...
        inquirer.prompt([
            {
                ...
                validate: function(input){
                    if (input === ""){
                        console.log("Invalid value! Please enter employee's name");
                        return false;
                    }
                    else{
                        return true;
            ...
            },
            {
                ...
                validate: function(input){
                    if (input === ""){
                        console.log("Invalid value! Please enter employee's Last name");
                        return false;
                    }
                    else{
                        return true;
